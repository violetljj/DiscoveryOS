...
35. CMI Search Value R1 V1 在 commit `1a3e3b5`、manifest `0a82137cdda8d406885b276e20b04308515e78ea5bf461a60c2a5e20e32114e7` 上因 `85,348 > 80,000` token envelope 于首个 terminal task receipt 前失效，failure receipt SHA-256 为 `fde8384ea996e1b588f5ba62b04b7fd71d7da85675eedac2d4b96cb0b7a9f438`。V2 在 commit `aec759c`、manifest `83a674e2e1fad3983e0b3166041fa10628fb2763c161c7a9f9d45d71a0f3e090` 上又于首个 terminal receipt 前遇到 invalid-descendant terminalization blocker：第二个 prefix candidate 已正确记为 `INVALID_MECHANICS/PATCH_APPLY_FAILURE`，但 runner 错误地继续 materialize invalid source 并抛错；failure receipt SHA-256 为 `1a40a742f6b2584210eb705146beef44c9d56747230ccd0f244772780324d02a`。两版均无 admitted scientific output，各自 partial task/cohort 永久不可重用。V3 只保留 V2 resource repair并修复 invalid terminalization，使用全新无筛选 cohort；必须先在 consumed task 上通过 exact real-provider preflight，才允许 seal。CMI、applicability、schedule、evaluator 与三道科学 gate 均未改变。详见 [`CMI_SEARCH_VALUE_R1.md`](CMI_SEARCH_VALUE_R1.md)。
